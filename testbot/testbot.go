...
// 	pairs := []string{ /*"1INCHUSDT", "AAVEUSDT", "ADAUSDT", "AIONUSDT", "AKROUSDT", "ALGOUSDT", "ALICEUSDT", "ALPHAUSDT", "ANKRUSDT", "ANTUSDT", "ARDRUSDT", "ARPAUSDT", "ASRUSDT", "ATMUSDT", "ATOMUSDT", "AUDIOUSDT", "AUDUSDT", "AVAUSDT", "AVAXUSDT", "AXSUSDT", "BALUSDT", "BANDUSDT", "BATUSDT", "BCCUSDT", "BCHABCUSDT", "BCHSVUSDT", "BCHUSDT", "BEAMUSDT", "BELUSDT", "BLZUSDT", "BNBUSDT", "BNTUSDT", "BTCSTUSDT", "BTCUSDT", "BTSUSDT", "BTTUSDT", "BUSDUSDT", "BZRXUSDT", "CAKEUSDT", "CELOUSDT", "CELRUSDT", "CHRUSDT", "CHZUSDT", "CKBUSDT", "COCOSUSDT", "COMPUSDT", "COSUSDT", "COTIUSDT", "CRVUSDT", "CTKUSDT", "CTSIUSDT", "CTXCUSDT", "CVCUSDT", "DASHUSDT", "DATAUSDT", "DCRUSDT", "DENTUSDT", "DGBUSDT", "DIAUSDT", "DNTUSDT", "DOCKUSDT", "DODOUSDT", "DOGEUSDT", "DOTUSDT", "DREPUSDT", "DUSKUSDT", "EGLDUSDT", "ENJUSDT", "EOSUSDT", "ERDUSDT", "ETCUSDT", "ETHUSDT",*/ "EURUSDT", "FETUSDT", "FILUSDT", "FIOUSDT", "FIROUSDT", "FLMUSDT", "FTMUSDT", "FTTUSDT", "FUNUSDT", "GBPUSDT", "GRTUSDT", "GTOUSDT", "GXSUSDT", "HARDUSDT", "HBARUSDT", "HCUSDT", "HIVEUSDT", "HNTUSDT", "HOTUSDT", "ICXUSDT", "INJUSDT", "IOSTUSDT", "IOTAUSDT", "IOTXUSDT", "IRISUSDT", "JSTUSDT", "JUVUSDT", "KAVAUSDT", "KEYUSDT", "KMDUSDT", "KNCUSDT", "KSMUSDT", "LINKUSDT", "LITUSDT", "LRCUSDT", "LSKUSDT", "LTCUSDT", "LTOUSDT", "LUNAUSDT", "MANAUSDT", "MATICUSDT", "MBLUSDT", "MDTUSDT", "MFTUSDT", "MITHUSDT", "MKRUSDT", "MTLUSDT", "NANOUSDT", "NBSUSDT", "NEARUSDT", "NEOUSDT", "NKNUSDT", "NMRUSDT", "NPXSUSDT", "NULSUSDT", "OCEANUSDT", "OGNUSDT", "OGUSDT", "OMGUSDT", "ONEUSDT", "ONGUSDT", "ONTUSDT", "ORNUSDT", "OXTUSDT", "PAXGUSDT", "PAXUSDT", "PERLUSDT", "PNTUSDT", "PSGUSDT", "QTUMUSDT", "REEFUSDT", "RENUSDT", "REPUSDT", "RLCUSDT", "ROSEUSDT", "RSRUSDT", "RUNEUSDT", "RVNUSDT", "SANDUSDT", "SCUSDT", "SFPUSDT", "SKLUSDT", "SNXUSDT", "SOLUSDT", "SRMUSDT", "STMXUSDT", "STORJUSDT", "STPTUSDT", "STRAXUSDT", "STXUSDT", "SUNUSDT", "SUSHIUSDT", "SXPUSDT", "TCTUSDT", "TFUELUSDT", "THETAUSDT", "TOMOUSDT", "TRBUSDT", "TROYUSDT", "TRUUSDT", "TRXUSDT", "TUSDUSDT", "TWTUSDT", "UMAUSDT", "UNFIUSDT", "UNIUSDT", "USDCUSDT", "USDTBIDR", "USDTBRL", "USDTDAI", "USDTIDRT", "USDTNGN", "USDTRUB", "USDTTRY", "USDTUAH", "UTKUSDT", "VETUSDT", "VITEUSDT", "VTHOUSDT", "WANUSDT", "WAVESUSDT", "WINGUSDT", "WINUSDT", "WNXMUSDT", "WRXUSDT", "WTCUSDT", "XEMUSDT", "XLMUSDT", "XMRUSDT", "XRPUSDT", "XTZUSDT", "XVSUSDT", "XZCUSDT", "YFIIUSDT", "YFIUSDT", "ZECUSDT", "ZENUSDT", "ZILUSDT", "ZRXUSDT"}
// 	bot.CollectKlinesCsv()
// 	intervalsToDownload := []string{"5m", "15m", "1h", "1d", "1w"}
// 	for indexofpair, pair := range pairs {
// 		// candlesticks.Fix1mCandles(bot.KlinesDataCsv[indexofpair][0], "1m", pair)
// 		pretty.Println(pair)
// 		for _, interval := range intervalsToDownload {
// candlesticks.ConvertInterval(bot.KlinesDataCsv[indexofpair][0], interval, pair)
// 		}
// 	}
...
// 	fromTimestamp, toTimestamp := bot.KlinesDataCsv[0][1][0].OpenTime+(60000*60*101)+1, bot.KlinesDataCsv[0][1][len(bot.KlinesDataCsv[0][1])-1].OpenTime
// 	istart, istop := utilities.GetStartStopCandles(bot.KlinesDataCsv[0][1], fromTimestamp, toTimestamp)
// 	mycandlesticks = utilities.CandlesToMyCandles(bot.KlinesDataCsv[0][1], istart, istop)
// 	candlesticks.ConvertToBinary(mycandlesticks, 0.01)
// 	bot.WalletFuturesUSDT = 1000
// 	// bot.FeeMaker = 0.00000
// 	// bot.FeeTaker = 0.00000
// 	bot.FeeMaker = 0.00036
// 	bot.FeeTaker = 0.00036
// }
...
func (bot *TestBot) CollectKlinesCsv() {
	...
	// pair := []string{ /*"1INCHUSDT", "AAVEUSDT", "ADAUSDT", "AIONUSDT", "AKROUSDT", "ALGOUSDT", "ALICEUSDT", "ALPHAUSDT", "ANKRUSDT", "ANTUSDT", "ARDRUSDT", "ARPAUSDT", "ASRUSDT", "ATMUSDT", "ATOMUSDT", "AUDIOUSDT", "AUDUSDT", "AVAUSDT", "AVAXUSDT", "AXSUSDT", "BALUSDT", "BANDUSDT", "BATUSDT", "BCCUSDT", "BCHABCUSDT", "BCHSVUSDT", "BCHUSDT", "BEAMUSDT", "BELUSDT", "BLZUSDT", "BNBUSDT", "BNTUSDT", "BTCSTUSDT", "BTCUSDT", "BTSUSDT", "BTTUSDT", "BUSDUSDT", "BZRXUSDT", "CAKEUSDT", "CELOUSDT", "CELRUSDT", "CHRUSDT", "CHZUSDT", "CKBUSDT", "COCOSUSDT", "COMPUSDT", "COSUSDT", "COTIUSDT", "CRVUSDT", "CTKUSDT", "CTSIUSDT", "CTXCUSDT", "CVCUSDT", "DASHUSDT", "DATAUSDT", "DCRUSDT", "DENTUSDT", "DGBUSDT", "DIAUSDT", "DNTUSDT", "DOCKUSDT", "DODOUSDT", "DOGEUSDT", "DOTUSDT", "DREPUSDT", "DUSKUSDT", "EGLDUSDT", "ENJUSDT", "EOSUSDT", "ERDUSDT", "ETCUSDT", "ETHUSDT", "EURUSDT"*/ "FETUSDT", "FILUSDT", "FIOUSDT", "FIROUSDT", "FLMUSDT", "FTMUSDT", "FTTUSDT", "FUNUSDT", "GBPUSDT", "GRTUSDT", "GTOUSDT", "GXSUSDT", "HARDUSDT", "HBARUSDT", "HCUSDT", "HIVEUSDT", "HNTUSDT", "HOTUSDT", "ICXUSDT", "INJUSDT", "IOSTUSDT", "IOTAUSDT", "IOTXUSDT", "IRISUSDT", "JSTUSDT", "JUVUSDT", "KAVAUSDT", "KEYUSDT", "KMDUSDT", "KNCUSDT", "KSMUSDT", "LINKUSDT", "LITUSDT", "LRCUSDT", "LSKUSDT", "LTCUSDT", "LTOUSDT", "LUNAUSDT", "MANAUSDT", "MATICUSDT", "MBLUSDT", "MDTUSDT", "MFTUSDT", "MITHUSDT", "MKRUSDT", "MTLUSDT", "NANOUSDT", "NBSUSDT", "NEARUSDT", "NEOUSDT", "NKNUSDT", "NMRUSDT", "NPXSUSDT", "NULSUSDT", "OCEANUSDT", "OGNUSDT", "OGUSDT", "OMGUSDT", "ONEUSDT", "ONGUSDT", "ONTUSDT", "ORNUSDT", "OXTUSDT", "PAXGUSDT", "PAXUSDT", "PERLUSDT", "PNTUSDT", "PSGUSDT", "QTUMUSDT", "REEFUSDT", "RENUSDT", "REPUSDT", "RLCUSDT", "ROSEUSDT", "RSRUSDT", "RUNEUSDT", "RVNUSDT", "SANDUSDT", "SCUSDT", "SFPUSDT", "SKLUSDT", "SNXUSDT", "SOLUSDT", "SRMUSDT", "STMXUSDT", "STORJUSDT", "STPTUSDT", "STRAXUSDT", "STXUSDT", "SUNUSDT", "SUSHIUSDT", "SXPUSDT", "TCTUSDT", "TFUELUSDT", "THETAUSDT", "TOMOUSDT", "TRBUSDT", "TROYUSDT", "TRUUSDT", "TRXUSDT", "TUSDUSDT", "TWTUSDT", "UMAUSDT", "UNFIUSDT", "UNIUSDT"} // /*"USDCUSDT", "USDTBIDR", "USDTBRL", "USDTDAI", "USDTIDRT", "USDTNGN", "USDTRUB", "USDTTRY", "USDTUAH",*/, "UTKUSDT", "VETUSDT", "VITEUSDT", "VTHOUSDT", "WANUSDT", "WAVESUSDT", "WINGUSDT", "WINUSDT", "WNXMUSDT", "WRXUSDT", "WTCUSDT", "XEMUSDT", "XLMUSDT", "XMRUSDT", "XRPUSDT", "XTZUSDT", "XVSUSDT", "XZCUSDT"} //, "YFIIUSDT", "YFIUSDT", "ZECUSDT", "ZENUSDT", "ZILUSDT", "ZRXUSDT"}
...
func (bot *TestBot) TestAlgorithm(from string, to string, pair string) {
	...
	// pair1 := []string{ /*"1INCHUSDT", "AAVEUSDT", "ADAUSDT", "AIONUSDT", "AKROUSDT", "ALGOUSDT", "ALICEUSDT", "ALPHAUSDT", "ANKRUSDT", "ANTUSDT", "ARDRUSDT", "ARPAUSDT", "ASRUSDT", "ATMUSDT", "ATOMUSDT", "AUDIOUSDT", "AUDUSDT", "AVAUSDT", "AVAXUSDT", "AXSUSDT", "BALUSDT", "BANDUSDT", "BATUSDT", "BCCUSDT", "BCHABCUSDT", "BCHSVUSDT", "BCHUSDT", "BEAMUSDT", "BELUSDT", "BLZUSDT", "BNBUSDT", "BNTUSDT", "BTCSTUSDT", "BTCUSDT", "BTSUSDT", "BTTUSDT", "BUSDUSDT", "BZRXUSDT", "CAKEUSDT", "CELOUSDT", "CELRUSDT", "CHRUSDT", "CHZUSDT", "CKBUSDT", "COCOSUSDT", "COMPUSDT", "COSUSDT", "COTIUSDT", "CRVUSDT", "CTKUSDT", "CTSIUSDT", "CTXCUSDT", "CVCUSDT", "DASHUSDT", "DATAUSDT", "DCRUSDT", "DENTUSDT", "DGBUSDT", "DIAUSDT", "DNTUSDT", "DOCKUSDT", "DODOUSDT", "DOGEUSDT", "DOTUSDT", "DREPUSDT", "DUSKUSDT", "EGLDUSDT", "ENJUSDT", "EOSUSDT", "ERDUSDT", "ETCUSDT", "ETHUSDT", "EURUSDT"*/ "FETUSDT", "FILUSDT", "FIOUSDT", "FIROUSDT", "FLMUSDT", "FTMUSDT", "FTTUSDT", "FUNUSDT", "GBPUSDT", "GRTUSDT", "GTOUSDT", "GXSUSDT", "HARDUSDT", "HBARUSDT", "HCUSDT", "HIVEUSDT", "HNTUSDT", "HOTUSDT", "ICXUSDT", "INJUSDT", "IOSTUSDT", "IOTAUSDT", "IOTXUSDT", "IRISUSDT", "JSTUSDT", "JUVUSDT", "KAVAUSDT", "KEYUSDT", "KMDUSDT", "KNCUSDT", "KSMUSDT", "LINKUSDT", "LITUSDT", "LRCUSDT", "LSKUSDT", "LTCUSDT", "LTOUSDT", "LUNAUSDT", "MANAUSDT", "MATICUSDT", "MBLUSDT", "MDTUSDT", "MFTUSDT", "MITHUSDT", "MKRUSDT", "MTLUSDT", "NANOUSDT", "NBSUSDT", "NEARUSDT", "NEOUSDT", "NKNUSDT", "NMRUSDT", "NPXSUSDT", "NULSUSDT", "OCEANUSDT", "OGNUSDT", "OGUSDT", "OMGUSDT", "ONEUSDT", "ONGUSDT", "ONTUSDT", "ORNUSDT", "OXTUSDT", "PAXGUSDT", "PAXUSDT", "PERLUSDT", "PNTUSDT", "PSGUSDT", "QTUMUSDT", "REEFUSDT", "RENUSDT", "REPUSDT", "RLCUSDT", "ROSEUSDT", "RSRUSDT", "RUNEUSDT", "RVNUSDT", "SANDUSDT", "SCUSDT", "SFPUSDT", "SKLUSDT", "SNXUSDT", "SOLUSDT", "SRMUSDT", "STMXUSDT", "STORJUSDT", "STPTUSDT", "STRAXUSDT", "STXUSDT", "SUNUSDT", "SUSHIUSDT", "SXPUSDT", "TCTUSDT", "TFUELUSDT", "THETAUSDT", "TOMOUSDT", "TRBUSDT", "TROYUSDT", "TRUUSDT", "TRXUSDT", "TUSDUSDT", "TWTUSDT", "UMAUSDT", "UNFIUSDT", "UNIUSDT"} // /* "USDCUSDT", "USDTBIDR", "USDTBRL", "USDTDAI", "USDTIDRT", "USDTNGN", "USDTRUB", "USDTTRY", "USDTUAH",*/, "UTKUSDT", "VETUSDT", "VITEUSDT", "VTHOUSDT", "WANUSDT", "WAVESUSDT", "WINGUSDT", "WINUSDT", "WNXMUSDT", "WRXUSDT", "WTCUSDT", "XEMUSDT", "XLMUSDT", "XMRUSDT", "XRPUSDT", "XTZUSDT", "XVSUSDT", "XZCUSDT", "YFIIUSDT", "YFIUSDT", "ZECUSDT", "ZENUSDT", "ZILUSDT", "ZRXUSDT"}
